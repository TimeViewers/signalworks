...
@pytest.fixture
def var():
    p1 = Partition(numpy.array([0, 5, 6, 10], dtype=numpy.int64), numpy.array(["start", "middle", "end"]), 1)
    p2 = Partition(numpy.array([0, 5, 10], dtype=numpy.int64), numpy.array(["start2", "end2"]), 1)
    return p1, p2

def test_insert():
    p = Partition(numpy.array([0, 5, 6, 10], dtype=numpy.int64), numpy.array(["start", "middle", "end"]), 1)
